### Gradient descent (GD) given a cost function f and its gradient 
...
### Stochastic gradient descent (SGD) given a cost function f and its gradient 
...
### Stochastic gradient descent with momentum (MSGD) given a cost function f and its gradient 
...
### Stochastic gradient descent with Nesterov accelerated gradient (NAGSGD) given a cost function f and its gradient 
...
### AdaGrad given a cost function f and its gradient 
...
### RMSProp given a cost function f and its gradient 
...
### Adam given a cost function f and its gradient 
